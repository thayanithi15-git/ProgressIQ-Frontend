...
const features = [
  {
    ...
    description: "Monitor daily activities and task updates instantly across teams and departments with live sync.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Smart Analytics",
    description: "AI-driven insights to measure productivity, progress, and performance metrics accurately.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Team Collaboration",
    description: "Centralized workspace for mentors, students, and administrators to work together efficiently.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Secure & Reliable",
    description: "Role-based access control with enterprise-grade security and data protection for your institution.",
    visual: "security",
  },
];
