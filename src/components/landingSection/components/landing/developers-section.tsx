...
const codeExamples = [
  {
    label: "Configure",
    code: `import { ProgressIQ } from '@progress-iq/core'

const portal = new ProgressIQ({
  institutionId: 'GLOBAL_UNI_01',
  region: 'us-east-1'
})`,
  },
  {
    label: "Map Roles",
    code: `// Bulk student-mentor mapping
await portal.roles.map({
  ...
  {
    label: "Monitor",
    code: `// Real-time activity monitoring
portal.activity.subscribe((update) => {
  console.log('New submission:', update.id)
  system.rankings.update()
})
