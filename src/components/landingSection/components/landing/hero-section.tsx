...
const words = ["track", "evaluate", "progress", "excel"];
        ...
        <div className="flex gap-16 marquee whitespace-nowrap">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex gap-16">
              {[
                { value: "50+", label: "Institutions", company: "GLOBAL" },
                { value: "10k+", label: "Active Students", company: "PROGRESS IQ" },
                { value: "1M+", label: "Verified Tasks", company: "TRACKER" },
                { value: "24/7", label: "Real-time Monitoring", company: "SECURE" },
              ].map((stat) => (
