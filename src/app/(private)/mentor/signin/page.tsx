        ...
        <div className="flex items-center justify-center p-6">
          ...
          >
            <div className="lg:hidden mb-8 text-center">
              ...
              <p className="text-secondary font-semibold">Mentor Portal</p>
            </div>
          ...
          <div className="relative z-10 p-16 flex flex-col justify-between text-white w-full">
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm font-semibold">Mentor Portal</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h2 className="text-3xl font-black leading-tight max-w-lg">
                Mentor <span className="text-white">Control</span>
              </h2>
