...
import { Lock, Mail, Shield, ArrowRight, Eye, EyeOff, Sparkles, Database, ShieldAlert } from "lucide-react";
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative">
          ...
          >
            <div className="lg:hidden mb-8 flex flex-col items-center text-center">
              <div className="inline-flex items-center gap-3 mb-3 h-12 w-12 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-700 justify-center shadow-lg shadow-indigo-500/20">
                <Image
                  src={"/progress_iq.png"}
              ...
              <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 font-poppins">Progress IQ</h1>
              <p className="text-indigo-600 font-bold tracking-wider uppercase text-xs mt-1">Admin Portal</p>
            </div>
            ...
            <Card className="border-0 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-2 sm:p-6 border">
              <CardHeader className="space-y-3 pb-6 border-b border-slate-100 mb-6">
                ...
                <CardDescription className="text-center text-slate-500 font-medium font-poppins text-sm">
                  Log in to the system control panel
                </CardDescription>
              </CardHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className="pl-12 h-12 bg-slate-50 border-slate-200 focus:bg-white focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 rounded-xl transition-all shadow-sm font-medium"
                        value={form.email}
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <a className="text-xs font-bold text-indigo-600 hover:text-indigo-700 cursor-pointer hover:underline transition-colors">
                        Forgot password?
                      </a>
                    </div>
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        placeholder="••••••••"
                        className="pl-12 pr-12 h-12 bg-slate-50 border-slate-200 focus:bg-white focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 rounded-xl transition-all shadow-sm font-medium"
                        value={form.password}
                        onChange={handleChange}
                        required
                      />
          ...
          <div className="relative z-10 p-12 w-full h-full flex flex-col justify-between text-white">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-400 text-xs font-bold uppercase tracking-widest mt-0.5">Administration</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h2 className="text-5xl font-medium leading-[1.15] tracking-tight font-poppins">
                Complete <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400 font-poppins">System Oversight</span>
              </h2>
              <p className="text-lg text-slate-300 font-medium leading-relaxed">
                Manage users, monitor performance metrics, configure system settings, and oversee platform activity.
              </p>
              ...
              <div className="flex gap-4 pt-6">
                <div className="flex-1 p-5 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 transition-colors">
                  ...
                  <div className="text-xs font-bold text-slate-400 uppercase tracking-wider">Uptime SLA</div>
                </div>
                <div className="flex-1 p-5 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:bg-white/10 transition-colors">
                  <div className="text-3xl font-black text-white mb-1">24/7</div>
                  <div className="text-xs font-bold text-slate-400 uppercase tracking-wider">Monitoring</div>
                </div>
              </div>
            </motion.div>
          </div>
