...
import { Lock, Mail, ArrowRight, Eye, EyeOff, Database } from "lucide-react";
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-12 relative z-10">
          ...
          >
            ...
            <div className="lg:hidden mb-12 flex flex-col items-center">
              ...
              <p className="text-muted-foreground font-mono text-xs uppercase tracking-widest mt-2">Admin Portal</p>
            </div>
              ...
              <div className="p-8 lg:p-10">
                <div className="mb-10 text-center">
                  <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-foreground/5 border border-foreground/10 mb-6">
                    <span className="text-[10px] font-mono font-bold text-muted-foreground uppercase tracking-[0.2em]">Admin Access</span>
                  </div>
                  <h2 className="text-4xl font-display tracking-tight mb-2">Control panel</h2>
                  <p className="text-muted-foreground text-sm">Authorized personnel only beyond this point</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? "Authenticating..." : "System Overview"}
          ...
          <div className="relative z-10 p-16 w-full h-full flex flex-col justify-between text-background">
            ...
            >
              ...
              <div>
                ...
                <p className="text-background/60 text-[10px] font-mono font-bold uppercase tracking-widest mt-1">Administration</p>
              </div>
            </motion.div>
            ...
            <div className="max-w-xl">
              ...
              >
                <div className="inline-flex p-4 bg-background/5 backdrop-blur-xl border border-background/10 rounded-2xl mb-4">
                  <Database className="w-8 h-8 text-background/80" />
                </div>
                <h2 className="text-6xl font-display leading-[1.1] tracking-tight">
                  Complete <span className="text-background/40">system oversight</span>
                </h2>
                <p className="text-lg text-background/60 leading-relaxed font-medium">
                  Manage users, monitor performance metrics, and oversee platform activity with enterprise-grade administration tools.
                </p>

                <div className="flex gap-12 pt-8">
                  <div>
                    <div className="text-4xl font-display mb-1">99.9%</div>
                    <div className="text-[10px] font-mono font-bold text-background/40 uppercase tracking-widest text-nowrap">Uptime SLA</div>
                  </div>
                  <div className="w-px h-full bg-background/10" />
                  <div>
                    <div className="text-4xl font-display mb-1">24/7</div>
                    <div className="text-[10px] font-mono font-bold text-background/40 uppercase tracking-widest text-nowrap">Monitoring</div>
                  </div>
                </div>
              </motion.div>
            </div>
