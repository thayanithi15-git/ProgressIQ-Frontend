...
import { Lock, Mail, ArrowRight, Eye, EyeOff, GraduationCap, Target } from "lucide-react";
      ...
      <div className="min-h-screen w-full flex font-sans bg-background overflow-hidden relative">
              ...
              <div className="p-8 lg:p-10">
                <div className="mb-10 text-center">
                  <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-foreground/5 border border-foreground/10 mb-6">
                    <span className="text-[10px] font-mono font-bold text-muted-foreground uppercase tracking-[0.2em]">Student Access</span>
                  </div>
        ...
        <div className="hidden lg:flex w-[50%] relative overflow-hidden bg-foreground flex-col">
          ...
          <div className="relative z-10 p-16 w-full h-full flex flex-col justify-between text-background">
            ...
            >
              <Image src="/progress_white.png" alt="Logo" width={56} height={56} className="shadow-2xl" />
              <div>
            ...
            <div className="max-w-xl">
              ...
              >
                <div className="inline-flex p-4 bg-background/5 backdrop-blur-xl border border-background/10 rounded-2xl mb-4">
                  <GraduationCap className="w-8 h-8 text-background/80" />
                </div>
                <h2 className="text-6xl font-display leading-[1.1] tracking-tight">
                  Empower your <span className="text-background/40">academic journey</span>
                </h2>
                ...
                <div className="flex gap-12 pt-8">
                  <div>
                    ...
                    <div className="text-[10px] font-mono font-bold text-background/40 uppercase tracking-widest text-nowrap">Active Students</div>
                  </div>
                  <div className="w-px h-full bg-background/10" />
                  <div>
                    <div className="text-4xl font-display mb-1">500+</div>
                    <div className="text-[10px] font-mono font-bold text-background/40 uppercase tracking-widest text-nowrap">Institutions</div>
                  </div>
                </div>
              </motion.div>
            </div>
